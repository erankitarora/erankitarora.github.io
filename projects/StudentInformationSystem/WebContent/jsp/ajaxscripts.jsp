...
function updatenewsjsp(form)
{
   ...
   var formData = new FormData(form);
	...
	{
		$('#maincenter').load('./jsp/admin/question1/question1.jsp');
	}
	function question1(interest)
	{
		//alert(interest);
		var xmlhttp;
		if (window.XMLHttpRequest)
		...
		xmlhttp.onreadystatechange=function()
		  {
		  if (xmlhttp.readyState==4 && xmlhttp.status==200)
			    document.getElementById("interest_question1").innerHTML=xmlhttp.responseText;
		  };
		xmlhttp.open("GET","question1?interest="+interest,true);
		xmlhttp.send();
	}
</script>
